...
typedef struct n_GBitmap
{
    ...
    n_GColor *palette;
    char palette_size;
    unsigned short row_size_bytes;
    char free_palette_on_destroy; // TODo move me to a bit status register above for size
    char free_data_on_destroy; // TODo move me to a bit status register above for size
    n_GRect bounds;
    char format;
} n_GBitmap;
